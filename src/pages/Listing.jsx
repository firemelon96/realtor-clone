...
function Listing() {
  ...
  return (
    <main>
        ...
        <div className='fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer rounded-full border-2 border-gray-300 w-12 h-12 flex justify-center items-center' onClick={()=>{
